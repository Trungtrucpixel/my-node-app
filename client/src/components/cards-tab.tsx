              ...
              <CardContent>
                ...
                <div className="mt-3">
                  ...
                  <ul className="list-unstyled">
                    <li>💰 Giá trị thẻ: {(cardBenefits.price / 1000000).toLocaleString('vi-VN')}M VND</li>
                    <li>📈 Cổ phần hiện tại: {cardBenefits.currentShares.toLocaleString('vi-VN')}</li>
                    <li>🎯 Giới hạn Maxout: {(cardBenefits.maxoutLimit / 1000000).toLocaleString('vi-VN')}M VND</li>
                    <li>🔄 Quy tắc: 1M VND = 1 Cổ phần, Maxout tại 210% giá trị thẻ</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
